...
; the Ni and the Di all equal to 1 produces 1/, where  is the golden ratio (described in section 1.2.2). 
; One way to approximate an infinite continued fraction is to truncate the expansion 
; after a given number of terms. Such a truncation -- a so-called k-term finite 
