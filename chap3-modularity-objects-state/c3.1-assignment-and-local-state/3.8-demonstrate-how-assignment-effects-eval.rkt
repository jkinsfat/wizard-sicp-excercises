...
;  result. Define a simple procedure f such that evaluating (+ (f 0) (f 1)) will return 
;  0 if the arguments to + are evaluated from left to right but will return 1 if the 
