...
; 
; Define a constructor make-segment and selectors start-segment and end-segment that define
; the representation of segments in terms of points. Furthermore, a point can be represented
...
; the average of the coordinates of the endpoints). To try your procedures, you'll need a way to print points:
...
(print-point (midpoint-segment (make-segment (make-point -5 200) (make-point 3 100))))