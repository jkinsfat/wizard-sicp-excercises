; Exercise 2.23.  The procedure for-each is similar to map. It takes as arguments a procedurei
;  and a list of elements. However, rather than forming a list of the results, for-each just applies the 
